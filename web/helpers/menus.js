...
export const MENUS = {
  ...
  debug: {
    caption: "Debug menu",
    items: [
      { key: "debug-evolve", label: "EVOLVE", caption: "Select a species to evolve into.", icon: "", submenu: "debug-evolve-species" },
  ...
  "debug-evolve-species": {
    caption: "Select target species",
    items: []
  },
  dead: {
    caption: "Pet is gone",
